"""Sample job description and candidate dataset for demo screening."""

SAMPLE_JOB_DESCRIPTION = """Python Developer
...
SAMPLE_CANDIDATES_CSV = """name,email,phone,skills,experience,education,certifications,company,resume_text
